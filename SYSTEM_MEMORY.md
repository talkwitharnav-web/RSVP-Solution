...
Added 2026-07-24. Two independent, unrelated auth systems — ported from the reference project's own admin/kitchen split, ["darkglory" admin credentials are stored in CLAUDE.md, added when the user next asks for a doc pass covering that]:
